    ...
    def get_shoulders_info(self, image, body_landmarks, angle_type, show_text=True) :
        ...
        for shoulder in self.shoulders:
            ...
            if shoulder == "left_shoulder":
                left_angle_yaw = self.get_angle(points , dimension="XZ")
                ...
                self.shoulders_output["Left"]["Yaw"] = left_angle_yaw


                #cv2.putText(image,"LS Y" + str(left_angle_yaw), (image.shape[1]//2-290,100), cv2.FONT_HERSHEY_SIMPLEX , 1 , (255 , 255 , 255) , 2)
                #print("L shoulder camera info","Yaw:",left_angle_yaw,"Pitch",left_angle_pitch,"Roll",left_angle_roll)
            ...
            if shoulder == "right_shoulder":
                right_angle_yaw = self.get_angle(points, dimension="XZ")
                ...
                self.shoulders_output["Right"]["Yaw"] = right_angle_yaw



                #cv2.putText(image,"R Sh Roll: " + str(right_angle_roll) + " Pitch: " + str(right_angle_pitch) + " Yaw: " + str(right_angle_yaw), (image.shape[1]//2-290,100), cv2.FONT_HERSHEY_SIMPLEX , 1 , (255 , 255 , 255) , 2)
                #if show_text:
